...
const styles = StyleSheet.create({
  ...
  favoritosBtnContenido: { alignItems: "center", justifyContent: "center" },
  favoritosBtnNumero: { color: "#000000", fontWeight: "800", fontSize: 13, lineHeight: 15, includeFontPadding: false, marginTop: 1 },
  favoritosListasCol: { width: 58, gap: 3 },
  listasBtn: {
    flex: 1,
