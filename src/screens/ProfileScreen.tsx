...
const styles = StyleSheet.create({
  ...
  estadisticasHeader: { flexDirection: "row", alignItems: "center", marginTop: 8, marginBottom: 4, paddingHorizontal: 16 },
  ...
  headerRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: 16, paddingTop: 4, paddingBottom: 6 },
  ...
  socialRow: { flexDirection: "row", justifyContent: "space-around", marginTop: 0, paddingVertical: 8, borderTopWidth: StyleSheet.hairlineWidth, borderBottomWidth: StyleSheet.hairlineWidth, borderColor: theme.colors.border },
  ...
  seccionTitulo: { fontSize: 16, fontWeight: "700", marginTop: 10, marginBottom: 6, paddingHorizontal: 16 },
